DROP TABLE IF EXISTS `sgyy_device_module`;
create table `sgyy_device_module`
(
    id                    int           not null auto_increment comment '主键id',
    cable_joint_device_id int           null comment '三供一业设备id',
    module_type_id        int           null comment '模块类型id',
    send_device_unique    varchar(255)  null comment '推送设备的唯一标识',
    send_device_field     varchar(255)  null comment '推送设备的参数字段',
    name                  varchar(255)  null comment '三供一业设备模块名称',
    section_status        int default 1 null comment '模块当前阈值状态',
...
(
    id                           int          not null auto_increment comment '主键id',
    cable_joint_device_id        int          null comment '三供一业设备id',
    cable_joint_device_module_id int          null comment '三供一业设备模块id',
    module_type_id               int          null comment '模块类型id',
